...
namespace PeliculasAPI.Helpers
{
    public class AutoMapperProfiles : Profile
    {
        ...
        private List<ActorPeliculaDetalleDTO> MapPeliculasActores(Pelicula pelicula, PeliculaDetallesDTO peliculaDetallesDTO)
        {
            ...
            foreach (var generoPelicula in pelicula.PeliculasActores)
            {
                resultado.Add(new ActorPeliculaDetalleDTO()
                { 
                    ActorId = generoPelicula.ActorId,
                    Personaje = generoPelicula.Personaje,
                    NombrePersona = generoPelicula.Actor.Nombre
                });
            }
