...
namespace PeliculasAPI.Controllers
{
    ...
    public class PeliculasController : CustomBaseController
    {
        ...
        public PeliculasController(ApplicationDbContext context, IMapper mapper, IFileStorage fileStorage, ILogger<PeliculasController> logger) : base(context,mapper)
        {
        ...
        public async Task<ActionResult<List<PeliculaDTO>>> Filtrar([FromQuery] FiltroPeliculaDTO filtroPeliculaDTO)
        {
            ...
            await HttpContext.InsertarParametrosDePaginacion(peliculasQueryable, filtroPeliculaDTO.CantidadRegistrosPorPagina);
        ...
        public async Task<ActionResult> Post([FromForm] PeliculaCreacionDTO peliculaCreacionDTO)
        {
            ...
            if (peliculaCreacionDTO.Poster != null)
            {
                using (var memoryStream = new MemoryStream())
                {
                    ...
                    pelicula.Poster = await fileStorage.GuardarArchivo(contenido, extension, contenedor, peliculaCreacionDTO.Poster.ContentType);
                }
            }
        ...
        public async Task<ActionResult> Put(int id, [FromForm] PeliculaCreacionDTO peliculaCreacionDTO)
        {
            ...
            if (peliculaCreacionDTO.Poster != null)
            {
                using (var memoryStream = new MemoryStream())
                {
                    ...
                    var contenido = memoryStream.ToArray();
                    var extension = Path.GetExtension(peliculaCreacionDTO.Poster.FileName);
                    peliculaDB.Poster = await fileStorage.EditarArchivo(contenido, extension, contenedor, peliculaDB.Poster, peliculaCreacionDTO.Poster.ContentType);
                }
            }
