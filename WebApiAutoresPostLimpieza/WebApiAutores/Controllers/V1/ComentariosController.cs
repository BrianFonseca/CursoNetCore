...
namespace WebApiAutores.Controllers.V1
{
    ...
    public class ComentariosController : ControllerBase
    {
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)] //si este authorize se pone a nivel controlador, se puede usar el httpcontext sin que de error, y en este endpoint se dejaria un allowAnonymous
